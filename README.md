## moveit (jazzy) - 2.12.3-1

The packages in the `moveit` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy moveit --override-release-repository-push-url git@github.com:revyos-ros/moveit2-release.git` on `Tue, 17 Jun 2025 09:54:53 -0000`
...
- release repository: https://github.com/revyos-ros/moveit2-release.git
...
## moveit (humble) - 2.5.9-1

The packages in the `moveit` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble moveit --override-release-repository-push-url git@github.com:revyos-ros/moveit2-release.git` on `Mon, 16 Jun 2025 06:35:24 -0000`
...
## moveit (jazzy) - 2.12.2-1

The packages in the `moveit` repository were released into the `jazzy` distro by running `/root/venv/bin/bloom-release -r jazzy moveit --override-release-repository-push-url git@github.com:revyos-ros/moveit2-release.git` on `Thu, 06 Mar 2025 03:55:35 -0000`
...
## moveit (humble) - 2.5.8-1

The packages in the `moveit` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble moveit --override-release-repository-push-url git@github.com:revyos-ros/moveit2-release.git` on `Mon, 17 Feb 2025 02:34:40 -0000`
...
## moveit (humble) - 2.5.7-1

The packages in the `moveit` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble moveit --override-release-repository-push-url git@github.com:revyos-ros/moveit2-release.git` on `Fri, 17 Jan 2025 05:17:58 -0000`
...
## moveit (jazzy) - 2.12.1-1

The packages in the `moveit` repository were released into the `jazzy` distro by running `/tmp/venv/bin/bloom-release -r jazzy moveit --override-release-repository-push-url git@github.com:revyos-ros/moveit2-release.git` on `Thu, 19 Dec 2024 11:05:55 -0000`
...
## moveit (jazzy) - 2.12.0-1

The packages in the `moveit` repository were released into the `jazzy` distro by running `/tmp/venv/bin/bloom-release -r jazzy moveit --override-release-repository-push-url git@github.com:revyos-ros/moveit2-release.git` on `Sun, 15 Dec 2024 12:14:38 -0000`
...
## moveit (humble) - 2.5.6-1

The packages in the `moveit` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble moveit --override-release-repository-push-url git@github.com:revyos-ros/moveit2-release.git` on `Fri, 13 Dec 2024 11:37:55 -0000`
...
## moveit (humble) - 2.5.5-2

The packages in the `moveit` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble moveit --override-release-repository-push-url git@github.com:revyos-ros/moveit2-release.git` on `Mon, 04 Nov 2024 04:06:12 -0000`
...
## moveit (jazzy) - 2.10.0-2

The packages in the `moveit` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy moveit --override-release-repository-push-url git@github.com:revyos-ros/moveit2-release` on `Wed, 19 Jun 2024 05:42:48 -0000`
...
## moveit (jazzy) - 2.10.0-1

The packages in the `moveit` repository were released into the `jazzy` distro by running `/home/henning/.local/bin/bloom-release --ros-distro jazzy --edit moveit` on `Fri, 14 Jun 2024 21:27:17 -0000`
...
## moveit (rolling) - 2.10.0-1

The packages in the `moveit` repository were released into the `rolling` distro by running `/home/henning/.local/bin/bloom-release --ros-distro rolling --edit moveit` on `Fri, 14 Jun 2024 20:54:43 -0000`
...
## moveit (jazzy) - 2.9.0-1

The packages in the `moveit` repository were released into the `jazzy` distro by running `/usr/local/google/home/marcogg/migration/bin/bloom-release moveit --rosdistro jazzy` on `Mon, 22 Apr 2024 11:37:53 -0000`
...
## moveit (rolling) - 2.9.0-2

The packages in the `moveit` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling moveit` on `Thu, 07 Mar 2024 16:21:40 -0000`
...
## moveit (rolling) - 2.9.0-1

The packages in the `moveit` repository were released into the `rolling` distro by running `/usr/bin/bloom-release moveit --rosdistro rolling` on `Wed, 10 Jan 2024 16:10:20 -0000`
...
## moveit (humble) - 2.5.5-1

The packages in the `moveit` repository were released into the `humble` distro by running `/home/henning/.local/bin/bloom-release --rosdistro humble moveit --debug -e` on `Sun, 10 Sep 2023 20:53:16 -0000`
...
The packages in the `moveit` repository were released into the `iron` distro by running `/home/henning/.local/bin/bloom-release --rosdistro iron moveit --debug` on `Sun, 10 Sep 2023 20:22:18 -0000`
...
The packages in the `moveit` repository were released into the `iron` distro by running `/home/tyler/.local/bin/bloom-release --rosdistro iron moveit` on `Thu, 18 May 2023 18:42:33 -0000`
...
## moveit (rolling) - 2.7.4-1

The packages in the `moveit` repository were released into the `rolling` distro by running `/home/tyler/.local/bin/bloom-release --rosdistro rolling moveit` on `Thu, 18 May 2023 18:21:56 -0000`
...
The packages in the `moveit` repository were released into the `iron` distro by running `/home/tyler/.local/bin/bloom-release --rosdistro iron moveit -n` on `Mon, 24 Apr 2023 19:49:11 -0000`
...
## moveit (rolling) - 2.7.3-1

The packages in the `moveit` repository were released into the `rolling` distro by running `/home/tyler/.local/bin/bloom-release --rosdistro rolling moveit -n` on `Mon, 24 Apr 2023 19:36:00 -0000`
...
## moveit (rolling) - 2.7.2-1

The packages in the `moveit` repository were released into the `rolling` distro by running `/home/tyler/.local/bin/bloom-release --rosdistro rolling moveit --override-release-repository-url https://github.com/ros2-gbp/moveit2-release.git` on `Tue, 18 Apr 2023 18:30:10 -0000`
...
The packages in the `moveit` repository were released into the `rolling` distro by running `/home/ubuntu/.local/bin/bloom-release --rosdistro rolling --track rolling --override-release-repository-push-url https://github.com/ros2-gbp/moveit2-release --override-release-repository-url https://github.com/ros2-gbp/moveit2-release moveit` on `Thu, 23 Mar 2023 20:15:50 -0000`
